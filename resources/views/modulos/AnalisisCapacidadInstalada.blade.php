        ...
        <div class="tab-content">
            <div class="tab-pane active" id="CapInst">
                <div class="col mg-b-20">
                    ...
                    <a href="#formCapInst" class="modal-effect btn btn-oblong btn-success" data-toggle="modal" data-effect="effect-slide-in-bottom">Agregar</a>
                </div>
                <div class="col-md">
...
<script>
    ...
    function llenarTablaCapacidadInstalada(){
        ...
        $.get("{{url('analisisCapacidadInstalada/getCapacidadInstalada')}}", {}, function(response){
            ...
            $("#CapacidadInstalda-Contenido").html(response);
